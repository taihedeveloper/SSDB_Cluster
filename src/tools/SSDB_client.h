...
public:
	...
	/*
	add migtate function 
	*/
	virtual Status slot_premigrating(const std::string &slot) = 0;
	virtual Status migrate_slot(const std::string &slot, const std::string &ip,
		int64_t port, int64_t timeout, int64_t speed) = 0;
	virtual Status slot_postmigrating(const std::string &slot) = 0;
	virtual Status slot_preimporting(const std::string &slot) = 0;
